...
<div class="pub">
      <div class="thumbnail">
        <img src="/images/ETRA25.png" />
      </div>
      <div class="publications">
       <div> 
        <h3>Decoding Cognitive Load: Eye-Tracking Insights into Working Memory and Visual Attention</h3>
        </div>
        <div class="author"><strong>Xiaofu Jin</strong>, Yunpeng Bai, Lina Xu, Shuai Ma, Danqing Shi, Luwen Yu, Mingming Fan</div>
        <div>
        <span class="venue">In ACM CHI Conference on Eye Tracking Research and Applications (ETRA'25)
        </span>
        </div>
        <div><span class="venue"><a href="/papers/ETRA25.pdf">PDF  | </a></span></div>
      </div>
</div>
